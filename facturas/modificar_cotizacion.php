...
$iva = $arr_iva['iva'];
$sql_numero_cotizacion ="select cot.id_factura,cot.numero_factura,
cot.kilometraje,cot.observaciones,cot.fecha as cotfecha
...
<table width="<?php echo $ancho_tabla ?>" border="1">
  <tr>
    ...
    <td><div id="titulos">
      <div align="center">COTIZACION No: <?php echo  $arr_cot['numero_factura']; ?>
  ...
  <tr>
    ...
    <input type="text"  id="cotfecha"value="<?php echo $arr_cot['cotfecha']; ?>" class="fila_llenar"></td>
  </tr>
</table>
<table width="<?php echo $ancho_tabla ?>" border="1">
  <tr>
...
<div id="div_observaciones" >
	OBSERVACIONES <BR>
<input type = "text" id = "observaciones" size="80px" class="fila_llenar" value ="<?php  echo $arr_cot['observaciones']  ?>">
<div>	
	<br>
<div id="finalizar" align="center">
		<br>
		<button id="finalizar_cotizacion">ACTUALIZAR COTIZACION</button>
	</div>	
