...
<table id="tablita"
 ...
 style="font-size:<?php echo $tamano_letra; ?>">
  <tr>
    <td width="20%">&nbsp;</td>
    <td width="25%"><?php  echo $arr_cot['nombre']  ?></td>
    <td width="15%">&nbsp;</td>
    <td width="26%">&nbsp;</td>
    <td width="14%">&nbsp;</td>
  </tr>
...
function mostrar_items_parametro($tabla,$id_cotizacion,$parametro,$conexion,$ancho_tabla,$tamano_letra_items){
 ...
 //echo '<br>'.$filas;
  ...
  if($parametro == 'M'){$nombre_bloque = 'MANO DE OBRA';}
  /*else {$nombre_bloque = 'ACEITES Y REPUESTOS';}*/
  
    if($parametro == 'A'){$nombre_bloque = 'ACEITE EXCENTO DE IVA';}
	 if($parametro == 'R'){$nombre_bloque = 'REPUESTOS';}
