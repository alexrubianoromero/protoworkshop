				...
				{		
						...
						if ($numero_filas > 0 )
						{
							...
							echo '<tr>';
							  ...
							  $suma_repuestos_aceites  = $suma_repuestos + $suma_aceites;

							  $valor_iva = (($suma_repuestos + $suma_manos_obra )* $arr_iva['iva'])/100;

							  $total_remision = $subtotal_remision + $valor_iva;
							  //echo '<tr><td></td><td></td><td></td><td>TOTAL</td><td>'.$total_remision.'</td></tr></table>';
							  echo '<tr><td></td><td></td><td></td><td></td><td></td><td></td></tr>';
							  echo '<tr><td></td><td></td><td></td><td></td><td>Subtotal Repuestos</td><td align="right">'.$suma_repuestos_aceites.'</td></tr>';
							  echo '<tr><td></td><td></td><td></td><td></td><td>Subtotal Manos de Obra</td><td align="right">'.$suma_manos_obra.'</td></tr>';
							  echo '<tr><td></td><td></td><td></td><td></td><td>SUB TOTAL</td><td align="right">'.$subtotal_remision.'</td></tr>';
							   echo '<tr><td></td><td></td><td></td><td></td><td>IVA</td><td align="right">'.$valor_iva.'</td></tr>';
							   echo '<tr><td></td><td></td><td></td><td></td><td>TOTAL</td><td align="right">'.$total_remision.'</td></tr>';
							  echo  '</table>' ;
